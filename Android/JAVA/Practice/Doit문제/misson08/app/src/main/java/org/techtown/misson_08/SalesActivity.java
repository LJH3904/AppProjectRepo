...
public class SalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button_Menu = findViewById(R.id.button_sales_menu);
        Button button_Login = findViewById(R.id.button_sales_login);

        //이전 액티비티에서 보낸 값을 받아오는 코드
        TextView textView_Result  = findViewById(R.id.textView_sales_Result);
        ...
        button_Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Goods_to_Login_Intent.putExtra("name","SalesActivity");
        ...
        button_Menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Goods_to_Menu_Intent.putExtra("name","SalesActivity");
