...
extension Color{
  ...
  static let customOrangeLight = Color("ColorOrangeLight")
  static let customBrownLight = Color("ColorBrownLight")
  static let colorBrownMedium = Color("ColorBrownMedium")
