...
struct RequirementView_Previews: PreviewProvider {
    static var previews: some View {
        NavigationStack {
            RequirementView(requirement: .constant(Requirement(locationString: "지역을 선택하세요", minBudget: 100000, maxBudget: 9000000, firstDate: Date(), lastDate: Date(timeInterval: 86400, since: .now), gender: .none, tendency: .none, purpose: .none, bucketList: .none)), isPresented: .constant(true))
